...
/* package MutableVectors-0.1.0.0 */
#ifndef VERSION_MutableVectors
#define VERSION_MutableVectors "0.1.0.0"
#endif /* VERSION_MutableVectors */
#ifndef MIN_VERSION_MutableVectors
#define MIN_VERSION_MutableVectors(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_MutableVectors */
...
#define CURRENT_COMPONENT_ID "MutableVectors-0.1.0.0-5xe3zoGX4dmKJyDkd0FRV8-MutableVectors"
